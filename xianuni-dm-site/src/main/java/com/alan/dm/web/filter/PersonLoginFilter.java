 ...
 */
@Component(value = "personLoginFilter")
public class PersonLoginFilter extends HandlerInterceptorAdapter {

    private static Logger LOGGER = LoggerFactory.getLogger(PersonLoginFilter.class);
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if(!StringUtils.isEmpty(userId)){
            ...
            String cookie= WebUtils.getCookie(request, Constants.COOKIE_NAME_PERSON);
